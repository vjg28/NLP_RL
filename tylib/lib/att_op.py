...
#from .complex_op import *			# not Present # my edit
from .cnn import *
from .sim_op import *
#from .qrnn import *				# not Present # my edit
from .rnn import *
...
# My edit
def _intra_attention(q1_embed, q2_embed, q1_len, q2_len,
                        att_type='SOFT', name="", reuse=False, proj=False,
                        dist_bias=10, initializer=None, dropout=None,
                        mask_a=None, mask_b=None, transform_layers=0,
                        pooling = 'MATRIX', proj_intra = 0):
...
def bidirectional_attention_connector(q1_embed,
	...
	# ___ Intra Attention
	if(use_intra):
		_i1_embed, _i2_embed =  _intra_attention(
										q1_embed, q2_embed,
										q1_len, q2_len,
										att_type=att_type,
